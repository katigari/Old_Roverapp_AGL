...
void demo_cb(Menu * menu, RoverButtons* btn, void * closure) {
 ...
 // RoverLightsDemo  * lights_demo = (RoverLightsDemo *)closure;
...
int main(int ac, char **av, char **env)
{
  ...
  //RoverLightsDemo rvl_demo(&lights);
 ...
 // demo_menu.add_option("9:Lights", demo_cb, &rvl_demo);
